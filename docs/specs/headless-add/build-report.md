...
| T-2 | done | `PENDING` | AC-19 | Router, process test, reviewer remediation pass. Continuation unavailable, fresh implementer fallback used. |
| T-3 | pending | — | AC-1, AC-2, AC-3, AC-4, AC-6, AC-7, AC-12, AC-21 | Flag add. |
