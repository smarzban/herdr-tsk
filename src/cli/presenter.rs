...
pub fn list_help() -> CliOutput {
    CliOutput {
        stdout: concat!(
            ...
            "Lists ready, started, blocked, and review tasks in the Git repo root by default, or your desk outside Git. The current directory outside Git remains available through --project=/full/path.\n",
