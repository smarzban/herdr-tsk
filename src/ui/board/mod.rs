...
pub use apply::{apply_dispatch_recovery_result, apply_intent, board_intent_may_persist};
...
pub use model::{
    project_option_label, BoardInputMode, BoardModel, IntentOutcome, ProjectScopeOption,
